  ...
  private void UpdateHead() {
    ...
    if (trackRotation) {
      ...
      if (target == null) {
				...
				transform.localRotation = new Quaternion(0f,0f,Mathf.Clamp(rot.z,-0.4f,0.4f),rot.w);
        ...
        transform.rotation = rot * target.rotation;
			...
			transform.parent.position = new Vector3(Mathf.Clamp(transform.parent.position.x+speed*Time.deltaTime*transform.localRotation.z,-58f,+58f),transform.parent.position.y,transform.parent.position.z);
